    ...
    <div className="container large">
      <div className="page-header dashboard">
        <div className="column left">
          <h1 className="entry-name">List of all products</h1>
          <div className="entry-description">
            <p>This is the list of products available for sale in Storefront. You can edit the products on the product detail page.</p>
          </div>
        </div>
        <div className="column right">
          <Button radius="md" variant="default" leftIcon={<Plus />} component={Link} to="./new-product">New Product</Button>
        </div>
      </div>
      <div className="empty-content">
        ...
        <div className="empty-content--content">
          ...
          <Button radius="md" size="md" component={Link} to="./new-product">Add The First Product</Button>
        </div>
      </div>
    </div>
  );
