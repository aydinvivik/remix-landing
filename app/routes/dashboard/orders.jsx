      ...
      <div className="container large">
        <div className="page-header dashboard style-2">
          <div className="column left">
            <h1 className="entry-name">Incoming Orders</h1>
            <div className="entry-description">
              <p>You can track your incoming orders on this screen. You can see the information about the order from the order detail screen and edit it again.</p>
            </div>
          </div>
        </div>
